...
if("TRUE" STREQUAL "TRUE")
  set(ball_chaser_SOURCE_PREFIX /home/phil/catkin_ws_Project_GoChaseIt/src/ball_chaser)
  set(ball_chaser_DEVEL_PREFIX /home/phil/catkin_ws_Project_GoChaseIt/devel)
  ...
  set(ball_chaser_INSTALL_PREFIX /home/phil/catkin_ws_Project_GoChaseIt/install)
...
if(NOT "/home/phil/catkin_ws_Project_GoChaseIt/devel/include " STREQUAL " ")
  set(ball_chaser_INCLUDE_DIRS "")
  set(_include_dirs "/home/phil/catkin_ws_Project_GoChaseIt/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ball_chaser' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/phil/catkin_ws_Project_GoChaseIt/src/ball_chaser/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/phil/catkin_ws_Project_GoChaseIt/devel/lib;/home/phil/catkin_ws_Project_GoChaseIt/devel/lib;/opt/ros/kinetic/lib)
